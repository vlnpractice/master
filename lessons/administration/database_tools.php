...
<tr><td align="center" nowrap>Name of a backup file to create in your data directory: <input class="field10" name="backupfile" value="backup.db" style="width:200px"></td></tr>
...
<tr><td align="center" nowrap><textarea class="field10" name="command" rows="15" style="width:550px"></textarea></td></tr>
<tr><td align="center">
<input type="submit" name="A1" value="Submit" class="button10">
</td></tr></table></td></tr></table></form>
<?PHP
...
$schema_create = ereg_replace(",".$line_separator."$","",$schema_create);
...
{ if (eregi("^$s[pr].*",$table[0])) dq("optimize table $table[0]",1); }
