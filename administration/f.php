...
function get_fckeditor_old($field_name,$value) {
global $s;
include_once("$s[phppath]/ckeditor/ckeditor.php") ;
$CKEditor = new CKEditor();
$CKEditor->returnOutput = true;
$CKEditor->basePath	= "$s[site_url]/ckeditor/";
return $CKEditor->editor("$field_name",str_replace('&quot;','"',stripslashes($value)));
}
