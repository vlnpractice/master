...
{ if ($country[flag]) $flag = '<img border="0" src="'.$s[site_url].'/images/flags/small/'.$country[flag].'">'; else $flag = '';
  ...
  echo '<tr>
  <td align="center"><input class="field10" style="width:50px" name="code['.$x.']" value="'.$country[code].'"></td>
  <td align="center"><input class="field10" style="width:350px" name="name['.$x.']" value="'.$country[name].'"></td>
  <td align="center"><input class="field10" style="width:350px" name="flag['.$x.']" value="'.$country[flag].'"></td>
