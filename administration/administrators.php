...
$n = mysql_insert_id();
if (in_array('all_links',$in[rights])) $in[rights][] = 'links';
if (in_array('all_articles',$in[rights])) $in[rights][] = 'articles';
if (in_array('all_news',$in[rights])) $in[rights][] = 'news';
if (in_array('all_videos',$in[rights])) $in[rights][] = 'videos';
if (in_array('all_blogs',$in[rights])) $in[rights][] = 'blogs';
$in[rights] = array_unique($in[rights]);
