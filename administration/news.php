...
echo info_line($pocet.' Print Outs Found');
...
<tr><td class="common_table_top_cell">Search for Print Outs</td></tr>
...
<option value="0">N/A</option><option value="yes">Print Outs which are currently valid</option>
<option value="no">Print Outs which are currently not valid</option><option value="future">Print Outs which will valid in the future</option><option value="past">Print Outs which have been valid in the past</option></select>
</td></tr>
...
echo $s[info].'<span class="text13a_bold">Print Outs Found: '.$pocet;
if (($pocet>1) AND ($od!=$do)) echo ', Showing Print Outs '.$od.' - '.$do.'</b></span><br /><br />'.$rozcesti;
else echo '<br /><br />';
echo '</span>';
