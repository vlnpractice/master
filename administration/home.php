...
echo '<div class="common_div_title_left" style="text-align:left;" onClick="open_close(\'div6\')";><img border="0" src="images/menu_news.png" style="margin-top:6px;margin-left:4px;margin-right:6px;">Print Outs</div>
...
if (in_array('users',$rights)) echo $left."users.php?action=prices_home\">Prices".$right;
if (in_array('users',$rights)) echo $left."orders_payments.php?action=orders_search_users\">Orders".$right;
echo '</div>';
