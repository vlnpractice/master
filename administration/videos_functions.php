...
echo '<tr>
<td align="left" nowrap>Video sort code</td>
<td align="left">'.$video[youtube_length].'</td>
</tr>';
echo $user_items;
echo '<tr>
...
<td align="left"><input class="field10" name="video['.$n.'][short_description]" style="width:650px;" maxlength=255 value="'.$video[short_description].'"></td>
</tr>
<tr>
...
<tr>
<td align="left" valign="top">Video sort code </td>
<td align="left" valign="top"><input class="field10" name="video['.$n.'][youtube_length]" style="width:100px" value="'.$video[youtube_length].'"></td>
</tr>
<tr>
<td align="left" valign="top">Thumbnail </td>
