...
$active = '<font color="green">Print Outs item is active</font>'; else $active = '<font color="red">Print Outs item is inactive</font>';
...
echo '<tr><td class="common_table_top_cell" colspan="2">Print Outs Item Features</td></tr>';
if ($n) echo '<tr>
<td align="left">Print Outs item number</td>
<td align="left">'.$n.'</td>
</tr>
<tr>
...
<tr>
<td align="left" nowrap>Print Outs item is enabled</td>
