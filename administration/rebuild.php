...
<tr>
<td align="center" valign="top"><input type="radio" name="action" value="create_index">
<!--
<select class="select10" name="create_index_cat">
<option value="0">All categories</option>
<option value="l">Links - All categories</option><?PHP echo select_list_first_categories('l_noalias',0) ?>
<option value="a">Articles - All categories</option><?PHP echo select_list_first_categories('a_noalias',0) ?>
<option value="b">Blogs - All categories</option><?PHP echo select_list_first_categories('b_noalias',0) ?>
<option value="v">Videos - All categories</option><?PHP echo select_list_first_categories('v_noalias',0) ?>
<option value="n">Print Outs - All categories</option><?PHP echo select_list_first_categories('n_noalias',0) ?>
</select> and its subcategories<br />
-->
