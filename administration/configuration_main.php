...
<a href="javascript:show_config(4)" style="font-weight:bold;">Print Outs & Videos</a> &nbsp;
...
<tr><td colspan=2 class="common_table_top_cell">Gold Classifieds #1</td></tr>
<tr>
<td align="left" valign="top">Mysql database host *</td>
<td align="left" valign="top"><INPUT class="field10" style="width:550px" name="other_gc1_dbhost" value="<?PHP echo $s[other_gc1_dbhost]; ?>"></td>
</tr>
<tr>
<td align="left" valign="top">Name of mysql database *</td>
<td align="left" valign="top"><INPUT class="field10" style="width:550px" name="other_gc1_dbname" value="<?PHP echo $s[other_gc1_dbname]; ?>"></td>
</tr>
<tr>
<td align="left" valign="top">Mysql database username</td>
<td align="left" valign="top"><input class="field10" style="width:550px" name="other_gc1_dbusername" value="<?PHP echo $s[other_gc1_dbusername]; ?>"></td>
</tr>
<tr>
<td align="left" valign="top">Mysql database password</td>
<td align="left" valign="top"><input class="field10" style="width:550px" name="other_gc1_dbpassword" value="<?PHP echo $s[other_gc1_dbpassword]; ?>"></td>
</tr>
<tr>
<td align="left" valign="top">Prefix of all tables *</td>
<td align="left" valign="top"><INPUT class="field10" style="width:550px" name="other_gc1_pr" value="<?PHP echo $s[other_gc1_pr]; ?>"></td>
</tr>
<tr>
<td align="left" valign="top">URL *</td>
<td align="left" valign="top"><INPUT class="field10" style="width:550px" name="other_gc1_url" value="<?PHP echo $s[other_gc1_url]; ?>"></td>
</tr>
<tr>
<td align="left" valign="top">Default style *</td>
<td align="left" valign="top"><INPUT class="field10" style="width:550px" name="other_gc1_def_style" value="<?PHP echo $s[other_gc1_def_style]; ?>"></td>
</tr>
<tr>
<td align="left" valign="top">Site name *</td>
<td align="left" valign="top"><INPUT class="field10" style="width:550px" name="other_gc1_site_name" value="<?PHP echo $s[other_gc1_site_name]; ?>"></td>
</tr>



<tr><td colspan=2 class="common_table_top_cell">Gold Classifieds #2</td></tr>
<tr>
<td align="left" valign="top">Mysql database host *</td>
<td align="left" valign="top"><INPUT class="field10" style="width:550px" name="other_gc2_dbhost" value="<?PHP echo $s[other_gc2_dbhost]; ?>"></td>
</tr>
<tr>
<td align="left" valign="top">Name of mysql database *</td>
<td align="left" valign="top"><INPUT class="field10" style="width:550px" name="other_gc2_dbname" value="<?PHP echo $s[other_gc2_dbname]; ?>"></td>
</tr>
<tr>
<td align="left" valign="top">Mysql database username</td>
<td align="left" valign="top"><input class="field10" style="width:550px" name="other_gc2_dbusername" value="<?PHP echo $s[other_gc2_dbusername]; ?>"></td>
</tr>
<tr>
<td align="left" valign="top">Mysql database password</td>
<td align="left" valign="top"><input class="field10" style="width:550px" name="other_gc2_dbpassword" value="<?PHP echo $s[other_gc2_dbpassword]; ?>"></td>
</tr>
<tr>
<td align="left" valign="top">Prefix of all tables *</td>
<td align="left" valign="top"><INPUT class="field10" style="width:550px" name="other_gc2_pr" value="<?PHP echo $s[other_gc2_pr]; ?>"></td>
</tr>
<tr>
<td align="left" valign="top">URL *</td>
<td align="left" valign="top"><INPUT class="field10" style="width:550px" name="other_gc2_url" value="<?PHP echo $s[other_gc2_url]; ?>"></td>
</tr>
<tr>
<td align="left" valign="top">Default style *</td>
<td align="left" valign="top"><INPUT class="field10" style="width:550px" name="other_gc2_def_style" value="<?PHP echo $s[other_gc2_def_style]; ?>"></td>
</tr>
<tr>
<td align="left" valign="top">Site name *</td>
<td align="left" valign="top"><INPUT class="field10" style="width:550px" name="other_gc2_site_name" value="<?PHP echo $s[other_gc2_site_name]; ?>"></td>
</tr>
...
<tr>
<td align="left" valign="top">URL's of images in the slideshow</td>
<td align="left" valign="top" nowrap>
<?PHP
for ($x=1;$x<=10;$x++)
echo '<input class="field10" style="width:550px" name="home_slideshow'.$x.'" value="'.$s["home_slideshow$x"].'"><br />';
?>
</td>
</tr>
...
<tr><td colspan=2 class="common_table_top_cell">Print Outs</td></tr>
<tr>
<td align="left" valign="top">Print Outs per page in categories *</td>
<td align="left" valign="top"><input class="field10" size=5 name="n_per_page" value="<?PHP echo $s[n_per_page]; ?>"></td>
</tr>
<tr>
<td align="left" valign="top">Number of news to display in special categories *<br /><span class="text10">It includes: New Print Outs, Top Rated Print Outs, Popular Print Outs, Editor Picks<br /></span></td>
<td align="left" valign="top"><input class="field10" size=5 name="n_new_page" value="<?PHP echo $s[n_new_page] ?>"></td>
</tr>
<tr>
<td align="left" valign="top">Print Outs per page on RSS pages *</td>
...
<tr>
<td align="left" valign="top">Discounts</td>
<td align="left" valign="top" nowrap>
<?PHP
for ($x=1;$x<=10;$x++)
echo 'Discount code: <input class="field10" style="width:100px;" name="discount_code'.$x.'" value="'.$s["discount_code$x"].'"> discount: <input class="field10" style="width:50px;" name="discount'.$x.'" value="'.$s["discount$x"].'">%<br />';
?>
</td>
</tr>
