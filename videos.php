...
if ($_GET[action]=='clean') clean_video_category($_GET[n]);
...
$a[user_defined] = trim(str_replace('<br>','     ',$a[user_defined]));
$a[user_defined] = str_replace('     ',', ',$a[user_defined]);
...
if ($a[tmpl_cat]=='category.html') $a[tmpl_cat] = 'videos.html';
...
page_from_template('category_special_videos.html',$a);
}
